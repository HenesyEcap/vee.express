...
<BODY>
    ...
    ?>	<div class="error-msg" id="error-msg"></div>
					...
					<p style="text-align:center">Already have an Account? <a style="color:white" class="register-link" href="login.php">Login</a></p>
						<p><a style="color:white" class="home-link" href="index.php">Back Home</a></p>
				</form>
			</div>
		</div>
	</div>
